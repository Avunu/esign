class MockForm {
	...
	set_active_tab(active_tab) {
		...
		const previousTabContent = this.active_tab?.tabs_content?.[0]?.querySelector(`#${previousTabId}`);
		const activeTabContent = this.active_tab?.tabs_content?.[0]?.querySelector(`#${activeTabId}`);
